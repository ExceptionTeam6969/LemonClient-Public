...
public class PacketHud extends HudElement {
    ...
    public static final HudElementInfo<PacketHud> INFO = new HudElementInfo<>(LemonClient.HUD_GROUP,"Packet Hud", "Displays your average send packets.",PacketHud::new);
