...
public class Logo extends HudElement {
    public static final HudElementInfo<Logo> INFO = new HudElementInfo<>(LemonClient.HUD_GROUP, "Logo", "You should use fabric api to see it!", Logo::new);
    ...
    public void render(HudRenderer renderer) {
        switch (logo.get()) {
            case Text -> image = new Identifier("lemon-client", "text.png");
            case NewText -> image = new Identifier("lemon-client", "newtext.png");
            case Jello -> image = new Identifier("lemon-client", "jellotext.png");
