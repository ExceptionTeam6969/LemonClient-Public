...
import static dev.lemonclient.addon.utils.gui.SmoothUtils.smoothMove;

public class NotificationsHud extends HudElement {
    public static final HudElementInfo<NotificationsHud> INFO = new HudElementInfo<>(LemonClient.HUD_GROUP, "Notifications", "Displays notifications on hud.", NotificationsHud::new);
