...
public class Radar extends HudElement {
    public static final HudElementInfo<Radar> INFO = new HudElementInfo<>(LemonClient.HUD_GROUP, "Radar", "Draws a Radar on your HUD telling you where entities are.", Radar::new);
