...
public class ToastNotifications extends HudElement {
    public static final HudElementInfo<ToastNotifications> INFO = new HudElementInfo<>(LemonClient.HUD_GROUP, "Toast Notifications", "Displays toast notifications on hud.", ToastNotifications::new);
