...
public class ModuleArrayList extends HudElement {
    public static final HudElementInfo<ModuleArrayList> INFO = new HudElementInfo<>(Hud.GROUP, "Array List", "Displays your active modules.", ModuleArrayList::new);
