...
public class CatGirl extends HudElement {
    public static final HudElementInfo<CatGirl> INFO = new HudElementInfo<>(LemonClient.HUD_GROUP, "Cat Girl", "You should use fabric api to see it!", CatGirl::new);
    ...
    private Identifier image = new Identifier("lemon-client", "catgirl.png");
    ...
    public void render(HudRenderer renderer) {
        switch (logo.get()) {
            case CatGirl -> image = new Identifier("lemon-client", "catgirl.png");
            case LiLiBai -> image = new Identifier("lemon-client", "lilibai.png");
            case CNMB -> image = new Identifier("lemon-client", "cnmb.png");
            case SBGun -> image = new Identifier("lemon-client", "sbgun.png");
            case FUFU -> image = new Identifier("lemon-client", "fufu.png");
        }
