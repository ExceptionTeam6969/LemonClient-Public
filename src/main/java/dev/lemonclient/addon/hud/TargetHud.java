...
public class TargetHud extends HudElement {
    ...
    public static final HudElementInfo<TargetHud> INFO = new HudElementInfo<>(LemonClient.HUD_GROUP, "Target Hud", "A target hud the fuck you thinkin bruv.", TargetHud::new);
