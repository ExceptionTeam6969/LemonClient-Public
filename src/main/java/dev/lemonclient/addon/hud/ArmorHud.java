...
public class ArmorHud extends HudElement {
    ...
    public static final HudElementInfo<ArmorHud> INFO = new HudElementInfo<>(LemonClient.HUD_GROUP, "Armor Hud Plus", "A target hud the fuck you thinkin bruv.", ArmorHud::new);
