    ...
    protected class WTopBarButton extends WPressable {
        ...
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            ...
            switch (getState(this)) {
                case 1:
                    GuiUtils.quadRoundedSide(renderer, this, color, ((LemonClientGuiTheme)theme).roundAmount(), false);
                    break;
                case 2:
                    GuiUtils.quadRoundedSide(renderer, this, color, ((LemonClientGuiTheme)theme).roundAmount(), true);
                    break;
                case 3:
                    GuiUtils.quadRounded(renderer, this, color, ((LemonClientGuiTheme)theme).roundAmount());
                    break;
                default:
