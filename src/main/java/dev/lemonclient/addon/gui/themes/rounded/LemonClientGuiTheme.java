...
import dev.lemonclient.addon.gui.themes.rounded.widgets.*;
...
import dev.lemonclient.addon.gui.themes.rounded.widgets.pressable.*;
...
public class LemonClientGuiTheme extends GuiTheme {
    ...
    // Colors
    public final Setting<SettingColor> accentColor = color("accent", "Main color of the GUI.", new SettingColor(130, 110, 255));
