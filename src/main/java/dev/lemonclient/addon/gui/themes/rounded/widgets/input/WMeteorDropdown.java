...
public class WMeteorDropdown<T> extends WDropdown<T> implements LemonClientGuiWidget {
    ...
    private static class WRoot extends WDropdownRoot implements LemonClientGuiWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            LemonClientGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements LemonClientGuiWidget {
        @Override
