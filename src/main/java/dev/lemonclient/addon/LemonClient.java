...
import dev.lemonclient.addon.modules.settings.*;
import dev.lemonclient.addon.gui.themes.rounded.LemonClientGuiTheme;
import dev.lemonclient.addon.hud.*;
import dev.lemonclient.addon.modules.combat.*;
import dev.lemonclient.addon.modules.info.*;
import dev.lemonclient.addon.modules.misc.*;
...
public class LemonClient extends MeteorAddon {
    ...
    public static final HudGroup HUD_GROUP = new HudGroup("LemonClient");
...
//        hud.register(ModuleArrayList.INFO);
    ...
    public static void log(String message) {
        System.out.println("[" + LemonClient.ADDON + "] " + message);
    }
